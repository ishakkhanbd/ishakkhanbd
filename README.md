...
I have 10+ years of experience in 3 areas: **Mechanical Design (Certified SolidWorks Professional CSWP), FEA (Certified in Advanced FEA by ASME), and Machine Learning (Professional Certification from IBM)**. 
...
18. Car Jack (Application: Automotive). 


**✅ Repository 3: FEA (Structural and Thermal simulation by ABAQUS, ANSYS, and ICEPAK):** https://github.com/ishakkhanbd/FEA-Projects 
...
26. Deformation of a helical spring (ANSYS Static Structural). 


**✅ Repository 4: Machine Learning (Python, TensorFlow, PyTorch):**
...
2. Root cause/failure analysis agents: a team of agents that researches failure modes of semiconductor equipment (OpenAI SDK), 
